/*
1. Desenvolva um algoritmo para testar se uma pilha P1 tem mais elementos que uma pilha
P2. Considere que P1 e P2 já existem. O protótipo da função deve ser:
...
int main(){
	...
	int verif = testaMaisElementos(p1, p2);
