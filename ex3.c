/*
3. Desenvolva um algoritmo para inverter a posição dos elementos de uma pilha P. Você
pode criar pilhas auxiliares, se necessário. Use o push e pop. O resultado precisa ser
dado na pilha P via parâmetro.
